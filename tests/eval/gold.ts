...
export const GOLD_CASES: GoldCase[] = [
  ...
  },
  {
    ...
    niceToHave: ["2007-bnp-paribas", "2023-credit-suisse-ubs"],
  },
  {
    id: "war-major-power",
    ...
    niceToHave: ["2001-911", "1973-opec-embargo", "1962-cuban-missile-crisis"],
  },
  {
    id: "carry-unwind",
  ...
  },
  {
    ...
    mustContain: ["2000-dotcom-peak", "1929-black-tuesday"],
  ...
  },
  {
    ...
    niceToHave: ["1998-russia-ltcm", "2020-covid-crash", "1970-penn-central"],
  },
  {
  ...
  {
    id: "commercial-paper-run",
    description: "Funding-market run on previously-AAA-treated paper",
    queryTags: {
      triggerType: "credit_event",
      regimeTags: ["credit_widening", "liquidity_squeeze", "bank_stress", "vol_spiking", "risk_off"],
      region: "US",
      surpriseFactor: 5,
      assetFocus: ["credit", "USTs"],
      dateHint: null,
      rationale: "funding-market run",
    },
    mustContain: ["1970-penn-central"],
    niceToHave: ["2007-bnp-paribas", "2008-lehman", "2020-covid-crash"],
  },
  {
    id: "em-currency-board-break",
    description: "Hard FX peg breaks under fiscal stress",
    queryTags: {
      triggerType: "currency_event",
      regimeTags: ["peg_break", "currency_devaluation", "sovereign_stress", "policy_uncertainty", "risk_off"],
      region: "EM",
      surpriseFactor: 4,
      assetFocus: ["USD", "EM credit"],
      dateHint: null,
      rationale: "currency-board collapse",
    },
    mustContain: ["2002-argentina-default"],
    niceToHave: ["1992-black-wednesday", "1997-thai-baht"],
  },
  {
    id: "commodity-corner",
    description: "Single-counterparty short squeeze in a commodity",
    queryTags: {
      triggerType: "structural_event",
      regimeTags: ["vol_spiking", "leverage_high", "positioning_extreme_short", "liquidity_squeeze"],
      region: "GLOBAL",
      surpriseFactor: 5,
      assetFocus: ["oil"],
      dateHint: null,
      rationale: "commodity squeeze",
    },
    mustContain: ["2022-lme-nickel"],
    niceToHave: ["1980-hunt-silver"],
  },
  {
    id: "geopolitical-binary-tail",
    description: "Geopolitical confrontation with binary resolution path",
    queryTags: {
      triggerType: "geopolitical",
      regimeTags: ["war_risk", "geopolitical_tail", "vol_spiking", "flight_to_quality", "risk_off"],
      region: "US",
      surpriseFactor: 5,
      assetFocus: ["S&P 500"],
      dateHint: null,
      rationale: "binary tail risk",
    },
    mustContain: ["1962-cuban-missile-crisis"],
    niceToHave: ["1990-iraq-kuwait", "2022-russia-ukraine"],
  },
];
